...
LEFT JOIN rms_layanan ON kun_yan_id=yan_id
LEFT JOIN rms_manusia ON kun_man_id=man_id
WHERE yan_nama='Poli Anak' AND kun_tgcheckin BETWEEN '2021-06-01' AND '2021-07-01'
UNION
SELECT
  '3512037' AS "KODE RS",
  'RS UMUM DAERAH ASEMBAGUS' AS 'NAMA RS',
  ...
  '35Prop' AS 'KODE PROPINSI', 
  '5' AS 'NO',
  'Obstetri & Ginekologi (Ibu Hamil)' AS 'JENIS KEGIATAN',
  COUNT(CASE WHEN man_kelamin='L' THEN 1 END) AS L,
  COUNT(CASE WHEN man_kelamin='P' THEN 1 END) AS P,
  COUNT(*) AS JUMLAH
FROM rms_kunjungan
LEFT JOIN rms_layanan ON kun_yan_id=yan_id
LEFT JOIN rms_manusia ON kun_man_id=man_id
WHERE yan_nama='Poli Kandungan' AND kun_tgcheckin BETWEEN '2021-06-01' AND '2021-07-01'
UNION
SELECT
  '3512037' AS "KODE RS",
  'RS UMUM DAERAH ASEMBAGUS' AS 'NAMA RS',
